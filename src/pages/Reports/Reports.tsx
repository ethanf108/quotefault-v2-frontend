...
import { Quote, Report } from "../../API/Types";
                    ...
                    <Card className="mb-3" key={i}>
                            ...
                            <QuoteCard quote={r.quote!} />
                            {
                                r.reports.map((r, j) =>
                                    <div key={`${i}-${j}`} className="mt-3">
                                        ...
                                        <i className="font-weight-light">{new Date(r.timestamp).toLocaleString().replace(", ", " at ")}</i>
                                    </div>
                                )
                            }
                        </CardBody>
                        ...
                        <CardFooter>
                            <div className="float-right">
                                <ConfirmDialog onClick={() => resolve(r, "HIDE")} buttonClassName="btn-warning">Hide</ConfirmDialog>
                                <ConfirmDialog onClick={() => resolve(r, "IGNORE")} buttonClassName="ml-1">Ignore</ConfirmDialog>
                            </div>
                        </CardFooter>
                    </Card>
                )
